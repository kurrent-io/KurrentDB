...
public class ProjectionsTests : SchemaRegistryServerTestFixture {
    ...
    public async Task on_schema_version_registered(CancellationToken cancellationToken) {
        ...
        await projection.ProjectRecord(new ProjectionContext<DuckDBConnection>(_ => ValueTask.FromResult(DuckDBConnectionProvider.GetConnection()), schemaCreatedRecord, cancellationToken));
        ...
        await projection.ProjectRecord(new ProjectionContext<DuckDBConnection>(_ => ValueTask.FromResult(DuckDBConnectionProvider.GetConnection()), schemaVersionRegisteredRecord, cancellationToken));
    ...
    public async Task on_schema_deleted(CancellationToken cancellationToken) {
        ...
        await projection.ProjectRecord(new ProjectionContext<DuckDBConnection>(_ => ValueTask.FromResult(DuckDBConnectionProvider.GetConnection()), schemaDeletedRecord, cancellationToken));

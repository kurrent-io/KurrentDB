...
public interface IPreparedStatement<TArgs> : IPreparedStatement
	...
	static abstract BindingContext Bind(in TArgs args, PreparedStatement statement);
}
...
public interface IParameterlessStatement : IPreparedStatement<ValueTuple> {
	static BindingContext IPreparedStatement<ValueTuple>.Bind(in ValueTuple args, PreparedStatement statement)
		=> new(statement);
}

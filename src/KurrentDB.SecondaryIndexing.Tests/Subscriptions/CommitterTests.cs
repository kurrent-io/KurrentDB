...
// 		var batchSize = 0;
//
// 		var indexCommitter = new Committer(5, () => {
...
// 		var commitSignal = new ManualResetEventSlim(false);
//
// 		var indexCommitter = new Committer(1000, () => {
// 			Interlocked.Increment(ref callCount);
// 			commitSignal.Set();
// 		}, CancellationToken.None);
//
...
//
// 		await using (indexCommitter = new(1000, () => {
...
//
// 		var indexCommitter = new Committer(3, () => {
...
// 		var commitSignal = new ManualResetEventSlim(false);
//
// 		var indexCommitter = new Committer(100, () => {
// 			Interlocked.Increment(ref callCount);
// 			commitSignal.Set();
// 		}, CancellationToken.None);
//
...
//
// 		// When
// 		var indexCommitter = new Committer(1, () => {
// 			Interlocked.Increment(ref callCount);
// 		}, cts.Token);
...
// 		// Given
// 		var indexCommitter = new Committer(10, () => { }, CancellationToken.None);
//
// 		// When
// 		await indexCommitter.DisposeAsync();
//

...
public class SecondaryIndexCheckpointTrackerTests {
	...
	[Fact]
	public async Task Concurrent_Start_Calls_Throw_Exception() {
		// Given
		var tracker = new SecondaryIndexCheckpointTracker(10, 100, _ => Task.CompletedTask);

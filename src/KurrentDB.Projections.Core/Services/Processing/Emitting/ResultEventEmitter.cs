...
public class ResultEventEmitter : IResultEventEmitter {
	...
	public EmittedEventEnvelope[] ResultUpdated(string partition, string result, CheckpointTag at)
		=> CreateResultUpdatedEvents(partition, result, at);
			...
			var result =
				new EmittedEventEnvelope(
					projectionResult == null
						? new(streamId, Guid.NewGuid(), "ResultRemoved", true, null, null, at, null)
						: new EmittedDataEvent(streamId, Guid.NewGuid(), "Result", true, projectionResult, null, at, null),

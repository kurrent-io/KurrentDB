...
internal abstract class ManagedProjectionStateBase(ManagedProjection managedProjection) {
...
internal class AbortedState(ManagedProjection managedProjection) : ManagedProjectionStateBase(managedProjection);

internal class AbortingState(ManagedProjection managedProjection) : ManagedProjectionStateBase(managedProjection) {
...
internal class CompletedState(ManagedProjection managedProjection) : ManagedProjectionStateBase(managedProjection);

internal class CreatingLoadingLoadedState(ManagedProjection managedProjection) : ManagedProjectionStateBase(managedProjection);

internal class DeletingState : ManagedProjectionStateBase {
	public DeletingState(ManagedProjection managedProjection) : base(managedProjection) {
		managedProjection.DeleteProjectionStreams();
	}
}

internal class FaultedState(ManagedProjection managedProjection) : ManagedProjectionStateBase(managedProjection);

internal class LoadingStateState(ManagedProjection managedProjection) : ManagedProjectionStateBase(managedProjection) {
	protected internal override void Stopped(CoreProjectionStatusMessage.Stopped message) {
...
internal class PreparedState(ManagedProjection managedProjection) : ManagedProjectionStateBase(managedProjection);

internal class PreparingState(ManagedProjection managedProjection) : ManagedProjectionStateBase(managedProjection) {
	protected internal override void Faulted(CoreProjectionStatusMessage.Faulted message) {
		SetFaulted(message.FaultedReason);
		ManagedProjection._persistedProjectionState.SourceDefinition = null;
	...
	protected internal override void Prepared(CoreProjectionStatusMessage.Prepared message) {
		...
		ManagedProjection._persistedProjectionState.SourceDefinition = message.SourceDefinition;
...
internal class RunningState(ManagedProjection managedProjection) : ManagedProjectionStateBase(managedProjection) {
	protected internal override void Faulted(CoreProjectionStatusMessage.Faulted message) {
		SetFaulted(message.FaultedReason);
	}
...
internal class StartingState(ManagedProjection managedProjection) : ManagedProjectionStateBase(managedProjection) {
	protected internal override void Started() {
...
internal class StoppedState(ManagedProjection managedProjection) : ManagedProjectionStateBase(managedProjection);

internal class StoppingState(ManagedProjection managedProjection) : ManagedProjectionStateBase(managedProjection) {
	protected internal override void Stopped(CoreProjectionStatusMessage.Stopped message) {

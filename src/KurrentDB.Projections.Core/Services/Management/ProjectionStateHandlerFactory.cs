...
public class ProjectionStateHandlerFactory {
	...
	public IProjectionStateHandler Create(
		...
		switch (kind.ToLowerInvariant()) {
			case "js":
				result = new JintProjectionStateHandler(name, source, enableContentTypeValidation,
					_javascriptCompilationTimeout, executionTimeout, _coreTracker.OnJsProjectionExecuted);
				break;
			case "native":

...
public sealed class ReaderSubscriptionDispatcher {
	...
	private readonly TimeSpan _readerSubscriptionTimeout = TimeSpan.FromMilliseconds(ESConsts.ReadRequestTimeout);
	...
	/// <returns></returns>
	public void PublishSubscribe(ReaderSubscriptionManagement.Subscribe request, object subscriber, bool scheduleTimeout) {
	...
	public IHandle<T> CreateSubscriber<T>() where T : EventReaderSubscriptionMessageBase => new Subscriber<T>(this);

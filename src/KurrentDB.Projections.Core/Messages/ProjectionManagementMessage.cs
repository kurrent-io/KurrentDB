...
public static partial class ProjectionManagementMessage {
	...
	public sealed class RunAs(ClaimsPrincipal runAs) {
		...
		public static bool ValidateRunAs(
			ProjectionMode mode,
			ReadWrite readWrite,
	...
	[DerivedMessage]
	public abstract partial class ProjectionDataBase(
		string name,
		string partition,
		...
		[UsedImplicitly] public string Partition { get; } = partition;
	...
	[DerivedMessage(ProjectionMessage.Management)]
	public partial class ProjectionResult(
		string name,
		string partition,
		string result,
		CheckpointTag position,
	...
	public partial class ProjectionQuery(
		...
		public string Query { get; } = query;
		public bool EmitEnabled { get; } = emitEnabled;
		[UsedImplicitly] public bool? TrackEmittedStreams { get; } = trackEmittedStreams;
		[UsedImplicitly] public bool? CheckpointsEnabled { get; } = checkpointsEnabled;
		[UsedImplicitly] public string Type { get; } = projectionType;
		[UsedImplicitly] public ProjectionSourceDefinition Definition { get; } = definition;
		[UsedImplicitly] public ProjectionOutputConfig OutputConfig { get; } = outputConfig;
	}
	...
	public static partial class Internal {
		...
		[DerivedMessage(ProjectionMessage.Management)]
		public partial class ReadTimeout(Guid correlationId, string streamId, Dictionary<string, object> parameters) : Message {

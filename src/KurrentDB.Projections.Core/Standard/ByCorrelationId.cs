...
public class ByCorrelationId : IProjectionStateHandler {
	...
	public ByCorrelationId(string source, [UsedImplicitly] Action<string, object[]> logger) {
	...
	public bool ProcessEvent(
		...
		var metadataDict = new Dictionary<string, string>
			{ { "$eventTimestamp", "\"" + data.Timestamp.ToString("yyyy-MM-ddTHH:mm:ss.ffffffZ") + "\"" } };
		...
		emittedEvents = [
			new(new EmittedDataEvent(_corrIdStreamPrefix + correlationId, Guid.NewGuid(), "$>", false, linkTarget, linkMetadata,

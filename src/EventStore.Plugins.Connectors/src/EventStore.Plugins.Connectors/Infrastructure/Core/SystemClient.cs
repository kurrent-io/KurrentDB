...
public interface ISystemClient {
    SystemClient.ManagementOperations Management { get; }
    SystemClient.WriteOperations Writing { get; }
    SystemClient.SubscriptionsOperations Subscriptions { get; }
    SystemClient.ReadOperations Reading { get; }
}
...
public class SystemClient : ISystemClient {
	public SystemClient(IPublisher publisher, ILoggerFactory? loggerFactory = null) {
		...
		Management    = new(Publisher, Logger);
		Writing       = new(Publisher, Logger);
		Subscriptions = new(Publisher, Logger);
		Reading       = new(Publisher, Logger);
	}

	IPublisher            Publisher { get; }
	ILogger<SystemClient> Logger    { get; }

	public ManagementOperations    Management    { get; private set; }
	public WriteOperations         Writing       { get; private set; }
	public SubscriptionsOperations Subscriptions { get; private set; }
	public ReadOperations          Reading       { get; private set; }

...
public abstract class RequestManagerBase :
	...
	public void Handle(StorageMessage.WrongExpectedVersion message) {
		FailureStreamIndexes = message.StreamIndexes;
		FailureCurrentVersions = message.CurrentVersions;
		CompleteFailedRequest(OperationResult.WrongExpectedVersion, "Wrong expected version.", message.CurrentVersions);
	}

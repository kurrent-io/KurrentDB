...
// 						Properties = {
// 							{ Constants.RecordProperties.SchemaNameKey, new() { StringValue = "my-event-type" } },
...
// 			Properties = {
// 				{ Constants.RecordProperties.SchemaNameKey, new() { StringValue = "my-event-type" } },
// 				{ Constants.RecordProperties.SchemaFormatKey, new() { StringValue = dataFormat } },
...
// 			properties.PropertiesValues.TryGetValue(Constants.RecordProperties.SchemaFormatKey, out var prop);
...
// 			Properties = {
// 				{ Constants.RecordProperties.SchemaNameKey, new() { StringValue = "my-event-type" } },
// 				{ Constants.RecordProperties.SchemaFormatKey, new() { StringValue = "bytes" } },
// 			},
// 		};
//
// 		// when
...
//
// 	[Theory]
// 	[InlineData(Constants.RecordProperties.SchemaNameKey)]
// 	[InlineData(Constants.RecordProperties.SchemaFormatKey)]
...
// 				Assert.Equal(Constants.RecordProperties.RequiredProperties, x.Value);
// 			});
// 	}
//
// 	[Theory]

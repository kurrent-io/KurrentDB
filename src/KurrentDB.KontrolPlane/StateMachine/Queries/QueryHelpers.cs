...
internal static class QueryHelpers {
	extension(DuckDBAdvancedConnection connection) {
		...
		public QueryResult<ValueTuple<string>, (EndPoint Address, DatabaseNodeRole Role, bool IsLeader, string Version), AllNodesQuery> GetDatabaseNodes(
			string databaseId)
			=> connection.ExecuteQuery<ValueTuple<string>, (EndPoint, DatabaseNodeRole, bool, string), AllNodesQuery>(new(databaseId));

...
static class McpMappers {
	...
	public static Neighbour ToModel(MemoryContracts.RetainResponse.Types.Neighbour n) => new() {
		Distance = n.Distance,
	...
	public static ReinforceResult ToModel(MemoryContracts.ReinforceResponse r) => new() {

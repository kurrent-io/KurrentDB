...
public class when_updating_a_persistent_projection_query_text<TLogFormat, TStreamId>
	...
	private const string NewProjectionSource = "fromAll().when({a:function(){return {};}});log(2);";

	protected override IEnumerable<WhenStep> When() {
		yield return new ProjectionSubsystemMessage.StartComponents(Guid.NewGuid());
		yield return new Command.Post(
			_bus, ProjectionMode.Continuous, ProjectionName, RunAs.System, "JS",
	...
	public void the_projection_state_can_be_retrieved() {
		...
		Assert.AreEqual(ProjectionName, actual.Name);
		// empty? why?

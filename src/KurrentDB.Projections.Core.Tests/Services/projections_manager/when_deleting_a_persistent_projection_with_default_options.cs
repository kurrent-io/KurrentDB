...
public class when_deleting_a_persistent_projection_with_default_options<TLogFormat, TStreamId>
	...
	protected override IEnumerable<WhenStep> When() {
		...
		yield return new Command.Delete(_bus, ProjectionName, RunAs.System, true, true, true);
	}

	[Test, Category("v8")]
	public void a_projection_deleted_event_is_written() {
		Assert.AreEqual(true, _consumer.HandledMessages.OfType<ClientMessageWriteEvents>()
			.Any(x => x.Events[0].EventType == ProjectionEventTypes.ProjectionDeleted && Helper.UTF8NoBom.GetString(x.Events[0].Data) == ProjectionName));
	}
}

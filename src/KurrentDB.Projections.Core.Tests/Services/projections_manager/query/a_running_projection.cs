...
namespace KurrentDB.Projections.Core.Tests.Services.projections_manager.query.a_running_projection;
...
public class when_handling_event<TLogFormat, TStreamId> : Base<TLogFormat, TStreamId> {
	protected override IEnumerable<WhenStep> When() {
		...
		yield return
			ReaderSubscriptionMessage.CommittedEventDistributed.Sample(
				Reader, new TFPos(200, 150), new TFPos(200, 150), "stream", 2, "stream", 1, false,

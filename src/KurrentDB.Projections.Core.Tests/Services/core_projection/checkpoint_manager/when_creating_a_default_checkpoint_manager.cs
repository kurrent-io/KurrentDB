...
public class when_creating_a_default_checkpoint_manager<TLogFormat, TStreamId>
	...
	protected override void When() {
		...
		_coreProjectionCheckpointWriter =
			new(_namingBuilder.MakeCheckpointStreamName(), _ioDispatcher, _projectionVersion, _projectionName);
		_namingBuilder = ProjectionNamesBuilder.CreateForTest("projection");
	}

	[Test]
	public void it_can_be_created() {
		_manager = new(_bus, _projectionCorrelationId, new(1, 0, 0), null, _ioDispatcher, _config,
	...
	public void null_publisher_throws_argument_null_exception() {
		Assert.Throws<ArgumentNullException>(() => {
			_manager = new(null, _projectionCorrelationId, new(1, 0, 0), null, _ioDispatcher, _config,
				"projection", new StreamPositionTagger(0, "stream"), _namingBuilder, _checkpointsEnabled, _coreProjectionCheckpointWriter,
				Opts.MaxProjectionStateSizeDefault);
		});
	}
	...
	public void null_io_dispatcher_throws_argument_null_exception() {
		Assert.Throws<ArgumentNullException>(() => {
			_manager = new(_bus, _projectionCorrelationId, new(1, 0, 0), null, null, _config, "projection",
				new StreamPositionTagger(0, "stream"), _namingBuilder, _checkpointsEnabled, _coreProjectionCheckpointWriter,
				Opts.MaxProjectionStateSizeDefault);
		});
	}
	...
	public void null_projection_config_throws_argument_null_exception() {
		Assert.Throws<ArgumentNullException>(() => {
			_manager = new(_bus, _projectionCorrelationId, new(1, 0, 0), null, _ioDispatcher, null, "projection",
				new StreamPositionTagger(0, "stream"), _namingBuilder, _checkpointsEnabled, _coreProjectionCheckpointWriter,
				Opts.MaxProjectionStateSizeDefault);
		});
	}
	...
	public void null_projection_name_throws_argument_null_exception() {
		Assert.Throws<ArgumentNullException>(() => {
			_manager = new(_bus, _projectionCorrelationId, new(1, 0, 0), null, _ioDispatcher, _config, null,
				new StreamPositionTagger(0, "stream"), _namingBuilder, _checkpointsEnabled, _coreProjectionCheckpointWriter,
				Opts.MaxProjectionStateSizeDefault);
		});
	}
	...
	public void null_position_tagger_throws_argument_null_exception() {
		Assert.Throws<ArgumentNullException>(() => {
			_manager = new(_bus, _projectionCorrelationId, new(1, 0, 0), null, _ioDispatcher, _config,
				"projection", null, _namingBuilder, _checkpointsEnabled, _coreProjectionCheckpointWriter,
				Opts.MaxProjectionStateSizeDefault);
		});
	}

...
public class
	...
	protected override void Given() {
		...
		ExistingEvent("$projections-projection-checkpoint", ProjectionEventTypes.ProjectionCheckpoint, """{"c": 100, "p": 50}""", _testProjectionState);
	...
	protected override void When() {
		...
		_bus.Publish(new EventReaderSubscriptionMessage.CheckpointSuggested(SubscriptionId, CheckpointTag.FromPosition(0, 160, 150), 77.7f, 0));
	...
	public void previous_state_is_saved_in_checkpoint_event() {
		...
		Assert.AreEqual(
			1,
			_writeEventHandler.HandledMessages.Count(v => v.Events.Any(e
					=> e.EventType == ProjectionEventTypes.ProjectionCheckpoint

...
class when_creating_jint_projection {
	...
	public void Setup() {
		_stateHandlerFactory =
			new ProjectionStateHandlerFactory(TimeSpan.FromMilliseconds(250), TimeSpan.FromMilliseconds(100), ProjectionExecutionTrackers.NoOp, ProjectionTrackers.NoOp);
	}

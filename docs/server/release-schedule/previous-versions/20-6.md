...
If you were using dev mode to avoid setting up certificates, please run EventStoreDB in insecure mode instead. If you are wanting to run EventStoreDB with certificates, please refer to [the documentation](../../configuration/security.md#protocol-security).

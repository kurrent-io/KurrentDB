...
Check the [getting started guide](/getting-started/introduction.md) for an introduction to KurrentDB and its features, along with detailed instructions to quickly get started.

...
| [ES-TrustedAuth](../security/user-authentication.md#externalised-authentication) | Allows a trusted intermediary to handle authentication                                             |
...
@tab Response
@[code{response}](@samples/http-api/delete-stream/hard-delete-stream.sh)
:::

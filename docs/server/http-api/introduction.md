...
@tab Response
@[code{response}](@samples/http-api/read-event.sh)
:::
...
::: tabs
@tab Request
@[code{curl}](@samples/http-api/delete-stream/append-event-deleted.sh)
@tab Response
@[code{response}](@samples/http-api/delete-stream/append-event-deleted.sh)
:::
